...
data <- read_excel("C:\\Users\\Athaurahman\\Downloads\\NSC-2025.xlsx", sheet="Sheet2")
...
dengan Y adalah persentase penduduk miskin dan X3 adalah persentase penduduk miskin.

Didapatkan nilai $\hat\beta_0 = 84.25520$ artinya nilai dugaan rataan indeks pembangunan manusia ketika rata-rata lama sekolah bernilai 0 persen adalah 84.25520%, akan tetapi nilai 0 tidak ada dalam selang pengamatan persentase penduduk miskin sehingga $\hat\beta_0$ tidak dapat didefinisikan lebih lanjut
...
Koefisien determinasi yang dihasilkan adalah 0.48314 atau  48.31% artinya keragaman persentase penduduk miskin yang dapat dijelaskan oleh persentase penduduk miskin adalah sebesar 48.31%, sisanya yaitu 51.69% dijelaskan oleh peubah lain yang tidak dimasukkan dalam model.
